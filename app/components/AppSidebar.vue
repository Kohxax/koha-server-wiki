...
<template>
    ...
    />
    <aside
      class="app-sidebar fixed top-14 bottom-0 left-0 z-50 flex w-64 shrink-0 flex-col overflow-hidden border-r bg-background transition-transform duration-300 ease-out md:relative md:top-auto md:z-auto md:translate-x-0 md:transition-[width]"
